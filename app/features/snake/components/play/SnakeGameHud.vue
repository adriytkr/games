...
<template>
  <div class="game-hud">
    <div class="game-score">
      <svg class="game-score-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="red" version="1.1" id="Capa_1" width="32" height="32" viewBox="0 0 45.721 45.721" xml:space="preserve">
      <g>
